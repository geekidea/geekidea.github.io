...
(function (global, factory) {
    ...
    Share.prototype.init = function () {
        ...
        shareHtml += _this.core.s.gitee ? '<li><a id="lg-share-gitee" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.giteeDropdownText + '</span></a></li>' : '';
        ...
        utils.on(_this.core.el, 'onAfterSlide.lgtm', function (event) {
            ...
            setTimeout(function () {
                ...
                document.getElementById('lg-share-gitee').setAttribute('href', 'https://gitee.com/intent/gitee?text=' + _this.core.items[event.detail.index].getAttribute('data-tweet-text') + '&url=' + encodeURIComponent(_this.core.items[event.detail.index].getAttribute('data-gitee-share-url') || window.location.href));
